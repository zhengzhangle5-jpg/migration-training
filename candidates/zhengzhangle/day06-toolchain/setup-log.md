...
对比每条数据，CURRENT_DATE字段存在数值上的差异，其余字段的记录均匹配统一，得到转移记录的正确率为75%

**总结：** 

1 因测试记录数过少，数据转移业务的正确性仍存疑
...
**2 oracle还有多种字符类型，CHAR,NCHAR,CLOB等**

**3 NOT NULL / DEFAULT / COMMENT 这些建表语句后的补充部分尚未解析**

**4 测试更多的记录，增加测试结果的可靠性**

**5 同样的，主键、索引等（这部分由人工操作）**
